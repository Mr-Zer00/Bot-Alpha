...
class InstagramBot:
    ...
    def login(self):
        ...
        time.sleep(random.randint(5, 6))
        self.curtir_fotos_com_a_hashtag("animesbrasil")  # Você pode alterar a hashtag que esta entre aspas

    @staticmethod
    def type_like_a_person(sentence, single_input_field):
        # Este trecho de código irá basicamente permitir que você simule a digitação como uma pessoa
    ...
    def curtir_fotos_com_a_hashtag(self, hashtag):
        ...
        time.sleep(5)
        for i in range(1, 2):  # Altere o segundo valor aqui para que ele desça a quantidade de páginas que você quiser:
...
Alfred-Bot = InstagramBot("Usuario", "password")
Alfred-Bot.login()
